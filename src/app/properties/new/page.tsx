...
import { 
  ...
  Shield, Building, DollarSign, GripVertical, Trash2, Save,
...
export default function CreatePropertyPage() {
  ...
  const handleSubmit = async () => {
    ...
    // Prepare the images (sort by main first)
    ...
    const newProperty = addProperty({
      ...
      images: imageUrls.length > 0 ? imageUrls : ['https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=800'],
      featured: false,
              ...
              {steps.map((step, index) => (
                <React.Fragment key={step.num}>
                  <button
                    ...
                    className={`flex items-center gap-3 ${activeStep >= step.num ? 'cursor-pointer' : 'cursor-default'}`}
                  >
